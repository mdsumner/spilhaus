...
Note that this R package was adapted from code available at https://github.com/rtlemos/spilhaus, we took the functions `from_lonlat_to_spilhaus_xy` and `from_spilhaus_xy_to_lonlat`. 
